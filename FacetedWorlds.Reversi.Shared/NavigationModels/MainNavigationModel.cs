...
namespace FacetedWorlds.Reversi.NavigationModels
{
    public class MainNavigationModel
    {
        ...
        private GameRequest _selectedGameRequest;
        ...
        private Independent _indSelectedGameRequest = new Independent();
        ...
        public GameRequest SelectedGameRequest
        {
            get { _indSelectedGameRequest.OnGet(); return _selectedGameRequest; }
            set { _indSelectedGameRequest.OnSet(); _selectedGameRequest = value; }
        }
